...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.ResponseHeaderPolicy())
	...
	relayV1Router.Use(middleware.ResponseHeaderPolicy())
	...
	relayMjRouter.Use(middleware.ResponseHeaderPolicy())
	relayMjRouter.Use(middleware.SystemPerformanceCheck())
	registerMjRouterGroup(relayMjRouter)

	relayMjModeRouter := router.Group("/:mode/mj")
	relayMjModeRouter.Use(middleware.RouteTag("relay"))
	relayMjModeRouter.Use(middleware.ResponseHeaderPolicy())
	...
	relaySunoRouter.Use(middleware.ResponseHeaderPolicy())
	...
	relayGeminiRouter.Use(middleware.ResponseHeaderPolicy())
